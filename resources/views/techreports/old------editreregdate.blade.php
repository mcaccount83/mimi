...
<section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-4">
            <form method="POST" name="admin-rereg-date" action='{{ route("techreports.updatereregdate",$chDetails->id) }}'>
                @csrf
    ...
    <div class="card card-primary card-outline">
        ...
        <!-- /.col -->
            ...
            <div class="card-body text-center">
              ...
              <a href="{{ route('techreports.reregdate') }}" class="btn bg-gradient-primary"><i class="fas fa-reply" ></i>&nbsp; Back</a>
              </div>
