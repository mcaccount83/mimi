   ...
   function showPositionInformation() {
    Swal.fire({
        ...
        html: `
            ...
            <p>The Display Position will be used in areas that are publicly visible. Examples: MIMI chapter screens, emails, pdf letters, forum signature, etc.</p>
            <br>
            <h4>MIMI Position</h4>
            ...
            <p>Multiple Secondary Positions may be chosen. Secondary Positions may allow additional access outside of normal chapter/coordinator menus/screens based on the
...
function showPositionAbbreviations() {
    Swal.fire({
        ...
        html: `
            <style>
                .swal-abbr-table td:first-child {
                    font-weight: bold;
                    padding-right: 1.5rem;
                    white-space: nowrap;
                }
            </style>
            <h4><strong>Conference Positions</strong></h4>
            <table class="swal-abbr-table">
            ...
            <br>
            <h4><strong>International Positions</strong></h4>
            <table class="swal-abbr-table">
                ...
                <tr><td><h4>IIC</h4></td><td><h4>International Inquiries Coordinator</h4></td></tr>
