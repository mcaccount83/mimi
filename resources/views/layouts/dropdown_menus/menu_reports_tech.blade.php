<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    {{-- <a class="dropdown-item" href="{{ route('techreports.reregdate') }}">Re-Registration Renewal Dates</a> --}}
      ...
      <a class="dropdown-item" href="{{ route('techreports.chapterlist') }}">Active Board Pages</a>
      <a class="dropdown-item" href="{{ route('techreports.chapterlistzapped') }}">Zapped Board Pages</a>
