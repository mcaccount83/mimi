                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-2 mb-1" id="cd_country-container" style="display: none;">
                                <select name="cd_country" id="cd_country" class="form-control" style="width: 100%;">
                ...
                <div class="row mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="card-body text-center mt-3">
                            <div class="col-md-12" style="color: #dc3545;">Page will automatically re-direct after application submission.</div>
                            <br>
