...
<section class="content-header">
    ...
    <!-- Main content -->
    <form method="POST" action='{{ route("chapreports.updatechaprpteinstatus",$chapterList[0]->id) }}'>
    @csrf
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card-body text-center">
              ...
              <a href="{{ route('chapreports.chaprpteinstatus') }}" class="btn bg-gradient-primary"><i class="fas fa-reply" ></i>&nbsp;&nbsp;&nbsp;Back</a>
              </div>
