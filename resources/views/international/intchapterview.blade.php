          ...
          <div class="box card">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="ch_name" class="form-control my-colorpicker1"  required value="{{ $chapterList[0]->name }}" >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-4 col-xs-12">
              ...
              <div class="form-group">
                <label>EIN</label>
                <input type="text" id="ch_ein" name="ch_ein" class="form-control my-colorpicker1" value="{{ $chapterList[0]->ein }}"  readonly>
              </div>
              </div>
              ...
              <div class="form-group">
                 @if(empty($chapterList[0]->ein_letter_path))
					<a class="btn btn-themeBlue margin" href=href="#" <?php echo "disabled";?>>No EIN Letter on File</a>
						    ...
						    @endif
                <input type="hidden" id="ch_ein_letter_path" name="ch_ein_letter_path" class="form-control my-colorpicker1" value="{{ $chapterList[0]->ein_letter_path }}"  readonly>
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-4 col-xs-12">
              ...
              <div class="form-group">
                ...
                <input type="text" name="ch_notes" class="form-control my-colorpicker1"  value="{{ $chapterList[0]->notes}}" >
              </div>
              </div>
              <!-- /.form group -->
            ...
            <div class="box-header with-border mrg-t-10">
              ...
              <div class="form-group">
                ...
                <input type="text" name="ch_pre_fname" class="form-control my-colorpicker1" value="{{ $chapterList[0]->first_name }}"  required >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                ...
                <input type="text" name="ch_pre_lname" class="form-control my-colorpicker1" value="{{ $chapterList[0]->last_name }}"  required >
              </div>
              </div>
                            <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                ...
                <input type="email" name="ch_pre_email" id="ch_pre_email" class="form-control my-colorpicker1"  value="{{ $chapterList[0]->bd_email }}"  required >
              ...
              <div class="form-group">
                ...
                <input type="text" name="ch_pre_phone" id="ch_pre_phone" class="form-control my-colorpicker1" value="{{ $chapterList[0]->phone }}"  required >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-12 col-xs-12">
              <div class="form-group">
                ...
                <input name="ch_pre_street" class="form-control my-colorpicker1" rows="4"   value="{{ $chapterList[0]->street_address }}" required>
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-4 col-xs-12">
              <div class="form-group">
                ...
                <input type="text" name="ch_pre_city" class="form-control my-colorpicker1"  value="{{ $chapterList[0]->city }}" required >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-4 col-xs-12">
              ...
              <div class="form-group">
                ...
                <input type="text" name="ch_pre_zip" class="form-control my-colorpicker1" value="{{ $chapterList[0]->zip }}"  required >
              </div>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" name="ch_avp_fname" id="ch_avp_fname" class="form-control my-colorpicker1" value="{{$AVPDetails[0]->avp_fname != ''  ? $AVPDetails[0]->avp_fname : ''}}"  >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                ...
                <input type="text" name="ch_avp_lname" id="ch_avp_lname" class="form-control my-colorpicker1" value="{{$AVPDetails[0]->avp_lname != ''  ? $AVPDetails[0]->avp_lname : ''}}"  >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                <label>Email</label>
                <input type="email" name="ch_avp_email" id="ch_avp_email" class="form-control my-colorpicker1" value="{{$AVPDetails[0]->avp_email != ''  ? $AVPDetails[0]->avp_email : ''}}" >
              ...
              <div class="form-group">
                <label>Phone</label>
                <input type="text" name="ch_avp_phone" id="ch_avp_phone" class="form-control my-colorpicker1" value="{{$AVPDetails[0]->avp_phone != ''  ? $AVPDetails[0]->avp_phone : ''}}"  required >
              </div>
              </div>
              <!-- /.form group -->
               <div class="col-sm-12 col-xs-12">
              <div class="form-group">
                ...
                <input name="ch_avp_street" id="ch_avp_street" class="form-control my-colorpicker1" rows="4"  value="{{$AVPDetails[0]->avp_addr != ''  ? $AVPDetails[0]->avp_addr : ''}}">
              </div>
              </div>
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                <label>City</label>
                <input type="text" name="ch_avp_city" id="ch_avp_city" class="form-control my-colorpicker1" value="{{$AVPDetails[0]->avp_city != ''  ? $AVPDetails[0]->avp_city : ''}}"  >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              ...
              <div class="form-group">
                <label>Zip</label>
                <input type="text" name="ch_avp_zip" id="ch_avp_zip"  class="form-control my-colorpicker1" value="{{$AVPDetails[0]->avp_zip != ''  ? $AVPDetails[0]->avp_zip : ''}}" >
              </div>
              </div>
              <!-- /.form group -->
              <div class="radio-chk">
              ...
              <div class="form-group">
                <label>First Name</label>
                <input type="text" name="ch_mvp_fname" id="ch_mvp_fname"  class="form-control my-colorpicker1" value="{{$MVPDetails[0]->mvp_fname != ''  ? $MVPDetails[0]->mvp_fname : ''}}" >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                <label>Last Name</label>
                <input type="text" name="ch_mvp_lname" id="ch_mvp_lname" class="form-control my-colorpicker1" value="{{$MVPDetails[0]->mvp_lname != ''  ? $MVPDetails[0]->mvp_lname : ''}}"  >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                <label>Email</label>
                <input type="email" name="ch_mvp_email" id="ch_mvp_email" class="form-control my-colorpicker1"  value="{{$MVPDetails[0]->mvp_email != ''  ? $MVPDetails[0]->mvp_email : ''}}" >
              ...
              <div class="form-group">
                <label>Phone</label>
                <input type="text" name="ch_mvp_phone" id="ch_mvp_phone" class="form-control my-colorpicker1" value="{{$MVPDetails[0]->mvp_phone != ''  ? $MVPDetails[0]->mvp_phone : ''}}"  required >
              </div>
              </div>
               <!-- /.form group -->
               <div class="col-sm-12 col-xs-12">
              <div class="form-group">
                <label>Street Address</label>
                <input name="ch_mvp_street" id="ch_mvp_street" class="form-control my-colorpicker1" rows="4" value="{{$MVPDetails[0]->mvp_addr != ''  ? $MVPDetails[0]->mvp_addr : ''}}" >
              </div>
              </div>
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                <label>City</label>
                <input type="text" name="ch_mvp_city" id="ch_mvp_city" class="form-control my-colorpicker1" value="{{$MVPDetails[0]->mvp_city != ''  ? $MVPDetails[0]->mvp_city : ''}}"  >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              ...
              <div class="form-group">
                <label>Zip</label>
                <input type="text" name="ch_mvp_zip" id="ch_mvp_zip"  class="form-control my-colorpicker1" value="{{$MVPDetails[0]->mvp_zip != ''  ? $MVPDetails[0]->mvp_zip : ''}}"  >
              </div>
              </div>
              <!-- /.form group -->
               <div class="radio-chk">
              ...
              <div class="form-group">
                <label>First Name</label>
                <input type="text" name="ch_trs_fname" id="ch_trs_fname" class="form-control my-colorpicker1" value="{{$TRSDetails[0]->trs_fname != ''  ? $TRSDetails[0]->trs_fname : ''}}"   >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                <label>Last Name</label>
                <input type="text" name="ch_trs_lname" id="ch_trs_lname" class="form-control my-colorpicker1" value="{{$TRSDetails[0]->trs_lname != ''  ? $TRSDetails[0]->trs_lname : ''}}"   >
              </div>
              </div>
             <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                <label>Email</label>
                <input type="email" name="ch_trs_email" id="ch_trs_email" class="form-control my-colorpicker1"  value="{{$TRSDetails[0]->trs_email != ''  ? $TRSDetails[0]->trs_email : ''}}" >
              ...
              <div class="form-group">
                <label>Phone</label>
                <input type="text" name="ch_trs_phone" id="ch_trs_phone" class="form-control my-colorpicker1" value="{{$TRSDetails[0]->trs_phone != ''  ? $TRSDetails[0]->trs_phone : ''}}"  required >
              </div>
              </div>
               <!-- /.form group -->
               <div class="col-sm-12 col-xs-12">
              <div class="form-group">
                <label>Street Address</label>
                <input name="ch_trs_street" id="ch_trs_street" class="form-control my-colorpicker1" rows="4" value="{{$TRSDetails[0]->trs_addr != ''  ? $TRSDetails[0]->trs_addr : ''}}"  >
              </div>
              </div>
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                <label>City</label>
                <input type="text" name="ch_trs_city" id="ch_trs_city" class="form-control my-colorpicker1" value="{{$TRSDetails[0]->trs_city != ''  ? $TRSDetails[0]->trs_city : ''}}"  >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              ...
              <div class="form-group">
                <label>Zip</label>
                <input type="text" name="ch_trs_zip" id="ch_trs_zip"  class="form-control my-colorpicker1" value="{{$TRSDetails[0]->trs_zip != ''  ? $TRSDetails[0]->trs_zip : ''}}" >
              </div>
              </div>
              <!-- /.form group -->
               <div class="radio-chk">
              ...
              <div class="form-group">
                <label>First Name</label>
                <input type="text" name="ch_sec_fname" id="ch_sec_fname" class="form-control my-colorpicker1" value="{{$SECDetails[0]->sec_fname != ''  ? $SECDetails[0]->sec_fname : ''}}"  >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                <label>Last Name</label>
                <input type="text" name="ch_sec_lname" id="ch_sec_lname" class="form-control my-colorpicker1" value="{{$SECDetails[0]->sec_lname != ''  ? $SECDetails[0]->sec_lname : ''}}"   >
              </div>
              </div>
             <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                <label>Email</label>
                <input type="email" name="ch_sec_email" id="ch_sec_email" class="form-control my-colorpicker1"  value="{{$SECDetails[0]->sec_email != ''  ? $SECDetails[0]->sec_email : ''}}"  >
              ...
              <div class="form-group">
                <label>Phone</label>
                <input type="text" name="ch_sec_phone" id="ch_sec_phone" class="form-control my-colorpicker1" value="{{$SECDetails[0]->sec_phone != ''  ? $SECDetails[0]->sec_phone : ''}}"  required  >
              </div>
              </div>
               <!-- /.form group -->
               <div class="col-sm-12 col-xs-12">
              <div class="form-group">
                <label>Street Address</label>
                <input name="ch_sec_street" id="ch_sec_street" class="form-control my-colorpicker1" rows="4" value="{{$SECDetails[0]->sec_addr != ''  ? $SECDetails[0]->sec_addr : ''}}"  >
              </div>
              </div>
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                <label>City</label>
                <input type="text" name="ch_sec_city" id="ch_sec_city" class="form-control my-colorpicker1" value="{{$SECDetails[0]->sec_city != ''  ? $SECDetails[0]->sec_city : ''}}"   >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              ...
              <div class="form-group">
                <label>Zip</label>
                <input type="text" name="ch_sec_zip" id="ch_sec_zip"  class="form-control my-colorpicker1" value="{{$SECDetails[0]->sec_zip != ''  ? $SECDetails[0]->sec_zip : ''}}"  >
              </div>
              </div>
              <!-- /.form group -->
               <div class="radio-chk">
              ...
              <div class="box-body">
               ...
               <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="ch_website" class="form-control my-colorpicker1" placeholder="http://www.momsclubofchaptername.com" value="{{$chapterList[0]->website_url}}"  id="validate_url" >
                        </div>
                        </div>
                          <!-- /.form group -->
                          <div class="col-sm-6 col-xs-12">
             ...
             <div class="box-header with-border mrg-t-10">
              ...
              <div class="form-group">
                ...
                <input type="text" name="ch_preknown" id="ch_preknown" class="form-control my-colorpicker1" value="{{ $chapterList[0]->former_name}}"  >
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              <div class="form-group">
                ...
                <input type="text" name="ch_sistered" id="ch_sistered" class="form-control my-colorpicker1" value="{{ $chapterList[0]->sistered_by}}"  >
              </div>
              </div>
                <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              ...
              <div class="form-group">
                ...
                <input type="text" name="ch_regnotes" class="form-control my-colorpicker1"  value="{{ $chapterList[0]->reg_notes}}" >
              </div>
              </div>
