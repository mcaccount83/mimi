<div class="accordion"  id="accordion">
    ...
    <input type="hidden" name="FurthestStep" id="FurthestStep" value="{{ $chFinancialReport->farthest_step_visited > 0 ? $chFinancialReport->farthest_step_visited : '0' }}" />
        ...
        <!------Start Step 1 ------>
     <div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '1' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-members">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '1' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '1' ? 'true' : 'false' }}">
                CHAPTER DUES
            </button>
        </h2>
        <div id="collapseOne" class="accordion-collapse collapse {{ $chFinancialReport->farthest_step_visited == '1' ? 'show' : '' }}" data-bs-parent="#accordion">
        ...
        <div class="col-12 row mb-3">
            ...
            <div class="col-md-12" id="divNoFullDues">
                ...
                <div class="col-12 d-flex gap-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="Dues0" name="Dues[]" value="0"
                            {{ in_array('0', $selectedValues) ? 'checked' : '' }}
                            onchange="ChapterDuesQuestionsChange()">
                        <label class="form-check-label" for="Dues0">Waived/No Dues</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="Dues1" name="Dues[]" value="1"
                            {{ in_array('1', $selectedValues) ? 'checked' : '' }}
                            onchange="ChapterDuesQuestionsChange()">
                        <label class="form-check-label" for="Dues1">Partial Dues</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="Dues2" name="Dues[]" value="2"
                            {{ in_array('2', $selectedValues) ? 'checked' : '' }}
                            onchange="ChapterDuesQuestionsChange()">
                        <label class="form-check-label" for="Dues2">Associate Members</label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="row mb-3" id="membersChangedDues" style="display:none">
        ...
        <div class="input-group">
         ...
         <div class="row mb-3" id="waived" style="display:none">
            ...
            <div class="col-md-6" style="display:none">
             ...
             <div class="row mb-3" id="partial" style="display:none">
            ...
            <div class="row mb-3" id="associate" style="display:none">
...
<!------Start Step 2 ------>
<div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '2' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-meetings">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '2' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '2' ? 'true' : 'false' }}">
...
<div class="row mb-3">
    ...
    <div class="row mb-3">
        <div class="col-12">
      <p><b>List all Service Projects below, even if there was no income or expense.</b> Briefly describe the project and who was benefited by it. List any income and expenses for each project.</p>
       </div>
    </div>
...
<!------Start Step 4 ------>
 <div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '4' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-parties">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '4' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '4' ? 'true' : 'false' }}">
                PARTIES & MEMBER BENEFITS
            </button>
        </h2>
        <div id="collapseFour" class="accordion-collapse collapse {{ $chFinancialReport->farthest_step_visited == '4' ? 'show' : '' }}" data-bs-parent="#accordion">
            <div class="accordion-body">
<section>
<div class="row mb-3">
        <div class="col-12">
  <p>If your members paid to attend any parties or members-only fun activities organized by your chapter, enter the amounts they paid your chapter here. For example, if your members paid money to the chapter to attend a Museum Day or Halloween Party, include those payments here. Include all Year-End Chapter Banquet income in this section. Do not include any money paid to or from your chapter for reservations at International MOMS Club events like Regional/State Luncheons or Workshops – that is listed in Step 5.</p>
  <p><i>(<b>Note:</b> If there are multiple entries for a party in your books, group all that one party’s income into one entry for this report – for example if your members were charged for your Holiday Party, add all the income from the Holiday Party together and write one entry for that party here.)</i></p>
  <p>If your chapter had any expenses for <strong>parties and/or members-only fun activities or expenses,</strong> enter the amounts here. Group all expenses for any party/activity into one entry for each event. (For example, one amount for all expenses for Holiday Party, one amount for Year-End Banquet, etc…) If everything was donated for the event, you will not have any expense listed here. You may list parties/activities with no expense, but be sure to explain that everything was potluck or donated in the description column, and put $0 in the expense column for that event. Also list gifts bought for members, members-only crafts, and/or refreshments for members-only activities below (modest gifts for volunteer recognition can be listed under “Other” Expenses).</p>
          </div>
    </div>
...
<!------Start Step 5 ------>
<div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '5' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-office">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '5' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '5' ? 'true' : 'false' }}">
                OFFICE & OPERATING EXPENSES
            </button>
        </h2>
        <div id="collapseFive" class="accordion-collapse collapse {{ $chFinancialReport->farthest_step_visited == '5' ? 'show' : '' }}" data-bs-parent="#accordion">
            <div class="accordion-body">
<section>
<div class="row mb-3">
        <div class="col-12">
  <p>Use this section to list individually any Office Expenses or other Operating Expenses. Please include only one expense type per line (i.e. website hosting, advertising, etc.).</p>
        </div>
    </div>
      <div class="row mb-3">
                                    <div class="col-md-4">
...
<div class="row">
                                    <div class="col-12">
    <strong>Other Office & Operating Expenses</strong>
    </div>
</div>
...
<!------Start Step 6 ------>
    <div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '6' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-international">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '6' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '6' ? 'true' : 'false' }}">
                INTERNATIONAL EVENTS & RE-REGISTRATION
            </button>
        </h2>
        <div id="collapseSix" class="accordion-collapse collapse {{ $chFinancialReport->farthest_step_visited == '6' ? 'show' : '' }}" data-bs-parent="#accordion">
            <div class="accordion-body">
<section>
<div class="row mb-3">
        <div class="col-12">
            <p>Annual Chapter Registration Fee paid to International MOMS Club.  Due by the end of your chapter's anniversary month each year.</p>
                </div>
    </div>
    <div class="row mb-3">
            <div class="col-md-4">
...
<div class="row mb-3">
        <div class="col-12">
    <p>International Events include any State/Regional/Conference Luncheons, Workshops or other events sponsored or organized by the International MOMS Club.  These events could be attended In Person or Virtually.</p>
    <p>“Event income” includes all money paid to your treasury by members for their reservations at those events and any income from fundraisers held to help offset the expense of members attending an International event. Also include any donations to your chapter to help build your raffle basket or chapter display.</p>
<p>“Event expenses” includes all money paid by your treasury to International for reservations or for members attending the event, raffle basket and display expenses, and any travel costs. If your chapter paid for all reservations from its treasury and did not charge members for attending, it will have expenses, but no income, in this category.</p>
                    </div>
    </div>
...
<div class="row mb-3">
        <div class="col-12">
    <p><b>List all Event Information.</b> Briefly describe the event and list any income and expenses.</p>
    </div>
</div>

<div class="row">
        <div class="col-12">
       <strong>International Event Registrations</strong>
    </div>
</div>
...
<!------Start Step 7 ------>
    <div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '7' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-donations">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '7' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '7' ? 'true' : 'false' }}">
                DONATIONS TO YOUR CHAPTER
            </button>
        </h2>
        <div id="collapseSeven" class="accordion-collapse collapse {{ $chFinancialReport->farthest_step_visited == '7' ? 'show' : '' }}" data-bs-parent="#accordion">
            <div class="accordion-body">
<section>
<div class="row mb-3">
        <div class="col-12">
<p><b>Monetary Donations:</b><br>
    For each donation of money (cash or checks), please list Donor Name, Address, Date of Donation and Amount. If the money was donated for a specific purpose, list that, too. If you received grants, include that income here.</p>
            </div>
    </div>
...
<div class="row mb-3">
        <div class="col-12">
<p><n>Non-Monetary Donations:<br>
    For each donation, please list Donor Name, Address, Date of Donation, Items Donated, and purpose of donation. Do not include a value for items donated except in the case of gift cards. Do list the value of any gift cards received in the description.</p>
        </div>
    </div>
...
<!------Start Step 8 ------>
<div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '8' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-other">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '8' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '8' ? 'true' : 'false' }}">
                OTHER INCOME & EXPENSES
            </button>
        </h2>
        <div id="collapseEight" class="accordion-collapse collapse {{ $chFinancialReport->farthest_step_visited == '8' ? 'show' : '' }}" data-bs-parent="#accordion">
            <div class="accordion-body">
<section>
<div class="row mb-3">
        <div class="col-12">
...
<!------Start Step 9 ------>
    <div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '9' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-financial">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '9' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '9' ? 'true' : 'false' }}">
                FINANCIAL SUMMARY
            </button>
        </h2>
        <div id="collapseNine" class="accordion-collapse collapse {{ $chFinancialReport->farthest_step_visited == '9' ? 'show' : '' }}" data-bs-parent="#accordion">
            <div class="accordion-body">
<section>
...
<h3>July 1, {{ $reportYearStart }} - June 30, {{ $reportYearEnd }}</h3>
@endif
</div>
</div>
<div class="row mb-3">
...
<div class="row mb-1 align-items-center">
        ...
        <div class="row mt-2">
            <div class="col-12 ps-4">
                <p>Office and Operating Expenses</p>
            </div>
        </div>
...
<div class="row mb-3">
    <div class="col-sm-12">
        <h3><strong>Net Income</strong></h3>
...
<!------Start Step 10 ------>
    <div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '10' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-reconciliation">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '10' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseTen"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '10' ? 'true' : 'false' }}">
                BANK RECONCILIATION
            </button>
        </h2>
        <div id="collapseTen" class="accordion-collapse collapse {{ $chFinancialReport->farthest_step_visited == '10' ? 'show' : '' }}" data-bs-parent="#accordion">
            <div class="accordion-body">
<section>
...
<!------Start Step 11 ------>
    <div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '11' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-990n">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '11' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseEleven"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '11' ? 'true' : 'false' }}">
                990N IRS FILING
            </button>
        </h2>
...
@endif
    ...
    <div class="col-12">
                                <div class="row mb-3">
             @if($userTypeId == \App\Enums\UserTypeEnum::DISBANDED)
                <label>Is a copy of your chapter's most recent 990N IRS Filing included?<span class="field-required">*</span></label>
            @else
                <label>Is a copy of your chapter's {{ $irsFilingName }} included?<span class="field-required">*</span></label>
            @endif
                                    <div class="col-12 d-flex gap-4">
                                        <div class="form-check form-check-inline">
...
<!------Start Step 12 ------>
    <div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '12' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-questions">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '12' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwelve"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '12' ? 'true' : 'false' }}">
                CHAPTER QUESTIONS
            </button>
        </h2>
        <div id="collapseTwelve" class="accordion-collapse collapse {{ $chFinancialReport->farthest_step_visited == '12' ? 'show' : '' }}" data-bs-parent="#accordion">
            <div class="accordion-body">
<section>
...
@if ($chActiveId == \App\Enums\ChapterStatusEnum::ACTIVE)
    <div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '13' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-questions">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '13' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirteen"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '13' ? 'true' : 'false' }}">
                AWARD NOMINATIONS
            </button>
        </h2>
        <div id="collapseThirteen" class="accordion-collapse collapse {{ $chFinancialReport->farthest_step_visited == '13' ? 'show' : '' }}" data-bs-parent="#accordion">
            <div class="accordion-body">
    <section>
    <div class="col-12 form-row mb-3">
            ...
            <div class="award_acc_con">
                ...
                <h5 class="awrd_sub_head">Chapter Award Types</h5>
                    <ul class="border_list">
                        ...
                        <li>
                        <strong>Outstanding Chapter</strong> (for chapters started before July 1, {{ $reportYearStart }})<br>
                        ...
                        <li>
                        <strong>Outstanding New Chapter</strong> (for chapters started after July 1, {{ $reportYearStart }})<br>
                        <em>Given for outstanding overall representation of MOMS Club goals, principles, and program (including program to members, community involvement, and support of International MOMS Club)</em>
                        </li>
                        <li>
...
<!------Start Step 14 ------>
    <div class="accordion-item {{ $chFinancialReport->farthest_step_visited == '14' ? 'active' : '' }}">
        <h2 class="accordion-header" id="accordion-header-questions">
            <button class="accordion-button {{ $chFinancialReport->farthest_step_visited == '14' ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourteen"
                    aria-expanded="{{ $chFinancialReport->farthest_step_visited == '14' ? 'true' : 'false' }}">
                SUBMIT REPORT
            </button>
        </h2>
        <div id="collapseFourteen" class="accordion-collapse collapse {{ $chFinancialReport->farthest_step_visited == '14' ? 'show' : '' }}" data-bs-parent="#accordion">
            <div class="accordion-body">
    <section>
    <div class="row mb-3">
        <div class="col-12">
            <b>Contact information for the person who completed the report.</b>
            <br>
    ...
    <div class="row">
        <div class="col-12 text-center">
            ...
            <p style="color:red">Report is currently Save Only. Submission will be available beginnign July 1st.</p>
