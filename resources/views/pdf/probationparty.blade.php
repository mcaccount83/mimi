...
<br>
    ...
    <p>After final review of your chapters 2018-2019 Annual Reports, there was an excessive amount spent by your chapter for parties and other related activities benefiting
    ...
    <p>Because your chapter exceeded the guidelines relating to party expenses, we have no choice but to place your chapter on probation.  The terms of your chapter’s probation
        ...
        <ol>
            <li>Submit quarterly Financial Reports to your Primary Coordiator outlining the amount of dues received both during that quarter and year-to-date, and the amount of
                funds spent on parties or other related activities, both during the quarter and year-to-date.<br>
                <br>
                Submit a budget for each individual party or event held by your chapter, for which the chapter pays more than $25.  This budget is due to the Primary Coordinator
    ...
    <p>Because of the seriousness of this situation, you must reply to me in writing (email is fine) so that I receive your reply by {{ $nextMonthDate }}, indicating that you and your
        chapter understand and agree to comply with the terms of this probation. </p>
    <p>This probation is not intended to punish your chapter, but rather to give your chapter the opportunity to be sure you thoroughly understand the guidelines, and to work
    ...
    <p>If you have any questions concerning either your chapter’s probationary status, or how to appropriately budget parties and other activities and events that benefit members
        only, please do not hesitate to contact your Primary Coordinator or myself. </p>
    <p>Sincerely,</p>
    <br>
    <br>
