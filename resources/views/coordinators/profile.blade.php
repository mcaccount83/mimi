...
<section class="content-header">
    ...
    <!-- Main content -->
    <form method="POST" action='{{ route("coordinator.updateprofile",$coordinatorDetails[0]->id) }}'>
    @csrf
  ...
  function PreSaveValidate(){
    ...
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            return $.ajax({
                url: '{{ route("coordinator.checkpassword") }}',  // Check current password route
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: '{{ route("coordinator.updatepassword") }}',
                type: 'PUT',
                data: {
                    _token: '{{ csrf_token() }}',
