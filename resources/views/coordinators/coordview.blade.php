...
<section class="content-header">
    ...
    <!-- Main content -->
    <form method="POST" action='{{ route("coordinators.updatecoord",$coordinatorDetails[0]->id) }}'>
    @csrf
    <section class="content">
              ...
              <!-- /.form group -->
					<div class="col-sm-6">
					  <div class="form-group">
						...
						<input type="text" name="cord_fname" class="form-control" value="{{ $coordinatorDetails[0]->first_name }}"  required onkeypress="return isAlphanumeric(event)" autocomplete="nope">
					  </div>
					</div>
					<!-- /.form group -->
					<div class="col-sm-6">
					  <div class="form-group">
						...
						<input type="text" name="cord_lname" class="form-control" value="{{ $coordinatorDetails[0]->last_name }}"  required onkeypress="return isAlphanumeric(event)" autocomplete="nope">
					  </div>
					</div>
					<!-- /.form group -->
					<div class="col-sm-12">
						<div class="form-group">
							...
							<input autocomplete="nope" name="cord_addr" class="form-control" rows="4"  required value="{{ $coordinatorDetails[0]->address }}	">
						</div>
					</div>
					<!-- /.form group -->
					<div class="col-sm-3">
						<div class="form-group">
							...
							<input type="text" name="cord_city" class="form-control"  value="{{ $coordinatorDetails[0]->city }}" required onkeypress="return isAlphanumeric(event)" autocomplete="nope">
						</div>
					</div>
					<!-- /.form group -->
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
					  <div class="form-group">
						...
						<input type="text" name="cord_zip" class="form-control"  value="{{ $coordinatorDetails[0]->zip }}" required onkeypress="return isNumber(event)" autocomplete="nope">
					  </div>
					</div>
					<!-- /.form group -->
					<div class="col-sm-6">
					  <div class="form-group">
						...
						<input type="email" name="cord_email" id="cord_email" class="form-control" onblur="checkDuplicateEmail(this.value,this.id)"  value="{{ $coordinatorDetails[0]->email }}" required autocomplete="nope">
					...
					<div class="col-sm-6">
					  <div class="form-group">
						...
						<input type="email" name="cord_sec_email" id="cord_sec_email" class="form-control"    value="{{ $coordinatorDetails[0]->sec_email }}" autocomplete="nope">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="cord_chapter" class="form-control" value="{{ $coordinatorDetails[0]->home_chapter }}"  required onkeypress="return isAlphanumeric(event)" autocomplete="nope" >
                        </div>
                      </div>
					<div class="col-sm-3">
						<div class="form-group">
      ...
      <!-- /.form group -->
        ...
        <div class="card-body text-center">
            <a href="{{ route('coordinators.coordroleview',$coordinatorDetails[0]->id) }}" class="btn bg-gradient-primary"><i class="fas fa-share" ></i>&nbsp;&nbsp;&nbsp;Update Coordinator Role</a>
                </div>
		</div>
    </div>
        <!-- /.box-body -->
