...
@section('breadcrumb', 'Chapters with No Inquiries Email')
                        ...
                        <div class="card-header">
                            <div class="dropdown">
                                <h3 class="card-title dropdown-toggle" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Chapters with No Inquiries Email
                                </h3>
            ...
            <table id="chapterlist" class="table table-sm table-hover" >
              <thead>
                ...
                @foreach($ChapterPres as $list)
                  <tr>
                        <td class="text-center align-middle"><a href="{{ url("/userreports/addinquiriesemail/{$list->id}") }}"><i class="bi bi-person-fill-add"></i></a></td>
                        <td>
