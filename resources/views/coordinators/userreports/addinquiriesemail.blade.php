                        ...
                        <div class="col-md-12">
                         <!-- /.form group -->
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-sm-3">
                                <input type="email" name="ch_inqemailcontact" id="ch_inqemailcontact" class="form-control" value="{{ $chDetails->inquiries_contact }}" placeholder="Inquiries Email Address" required >
                                </div>
                                <div class="col-sm-7">
