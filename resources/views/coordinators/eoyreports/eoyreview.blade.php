...
@section('content')
 ...
 <section class="content">
    ...
    <tr>
        ...
        <th rowspan="2">Ext/Ret</th>
        <th rowspan="2">Rcvd</th>
                ...
                <tbody>
                    @foreach($chapterList as $list)
                        <tr>
                            ...
                            <td @if($list->documentsEOY?->financial_review_complete != '1' && $list->documentsEOY?->financial_report_received == '1') style="background-color:#dc3545; color: #ffffff;" @else style="background-color: transparent;" @endif>
                                @if($list->documentsEOY?->financial_review_complete == '1') YES
                                @elseif($list->documentsEOY?->financial_review_complete != '1' && $list->documentsEOY?->financial_report_received == '1') NO
                                @else
                                @endif
                            </td>
                        </tr>
