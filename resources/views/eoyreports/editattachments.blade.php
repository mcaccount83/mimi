                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-9">
                                @if (!empty($chDetails->documentsEOY->roster_path))
                                    <button class="btn bg-gradient-primary btn-sm" type="button" id="eoy-roster" onclick="openPdfViewer('{{ $chDetails->documentsEOY->roster_path }}')">View Chapter Roster</button>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-9">
                            @if (!empty($chDetails->documentsEOY->statement_1_path))
                                <button class="btn bg-gradient-primary btn-sm" type="button" id="eoy-statement-1" onclick="openPdfViewer('{{ $chDetails->documentsEOY->statement_1_path }}')">View Bank Statement</button>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-9">
                                @if (!empty( $chDetails->documentsEOY->statement_2_path))
                                    <button class="btn bg-gradient-primary btn-sm" type="button" id="eoy-statement-2" onclick="openPdfViewer('{{ $chDetails->docudocumentsEOYments->statement_2_path }}')">View Additional Bank Statement</button>
