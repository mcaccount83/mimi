...
@section('content')
  ...
  <section class="content-header">
    ...
    <!-- Main content -->
    <form method="POST" action='{{ route("eoyreports.eoyupdatestatus",$chapterList[0]->id) }}'>
    @csrf
      ...
      <!-- /.form group -->
            <div class="col-sm-3">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('eoyreports.eoystatus') }}" class="btn bg-gradient-primary"><i class="fas fa-reply" ></i>&nbsp; Back</a>
              </div>
              </div>
            </div>
        </div>
