...
@section('content')
  ...
  <section class="content-header">
    ...
    <!-- Main content -->
    <form method="POST" action='{{ route("eoyreports.eoyupdateattachments",$chapterList[0]->id) }}'>
    @csrf
      ...
      <div class="col-md-12">
        ...
        @endif
                ...
                <div class="card-body text-center">
                    <a href="{{ route('eoyreports.eoyattachments') }}" class="btn bg-gradient-primary"><i class="fas fa-reply" ></i>&nbsp; Back</a>
                </div>
                    </div>
                </div>
            </div>
