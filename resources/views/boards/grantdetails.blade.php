    ...
    <div class="container">
        ...
        <div class="container-fluid">
                   <form id="grant_request" name="grant_request" role="form" data-toggle="validator"
                    ...
                    action='{{ route("board.updategrantrequest", ["id" => $chDetails->id]) }}'>
                    @csrf
    ...
    <div class="col-12" id="accordion">
                ...
                <div class="card-body">
                    <section>
                       ...
                       <div class="form-group">
                        <label>
                            <input type="checkbox" name="understood" class="mr-2" value="1"
                    ...
                    <div class="form-group">
                        <label>
                            <input type="checkbox" name="member_agree" class="mr-2" value="1"
                    ...
                    <div class="form-group">
                        <label>
                            <input type="checkbox" name="member_accept" class="mr-2" value="1"
        ...
        <div class="card card-primary">
            <div class="card-header" id="accordion-header-submitter">
                <h4 class="card-title w-100">
                    <a class="d-block" data-toggle="collapse" href="#collapseSubmitter" style="width: 100%;">SUBMITTER INFORMATION</a>
                </h4>
            </div>
                ...
                <div class="card-body">
                    <section>
                        ...
                        <div class="col-12 form-row form-group">
                            <div class="col-md-6 float-left">
                                <div class="form-group">
                                    <label>Your Name<span class="field-required">*</span></label>
                                    <input type="text" class="form-control" name="submitter_name" value="{{ $borDetails->first_name }} {{ $borDetails->last_name }}" disabled>
                                </div>
                            </div>
                            <div class="col-md-6 float-left">
                                <div class="form-group">
                                    <label>Your Position in Chapter<span class="field-required">*</span></label>
                        ...
                        <div class="col-12 form-row form-group">
                            <div class="col-md-6 float-left">
                                <div class="form-group">
                                    <label>Your Phone<span class="field-required">*</span></label>
                                    <input type="tel" class="form-control" name="submitter_phone" value="{{ $borDetails->phone }}" disabled>
                                </div>
                            </div>
                            <div class="col-md-6 float-left">
                                <div class="form-group">
                                    <label>Your Email<span class="field-required">*</span></label>
                                    <input type="email" class="form-control" name="submitter_email" value="{{ $borDetails->email }}" disabled>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="card-body text-center">
                            <button type="button" id="btn-step-2" class="btn btn-primary"><i class="fas fa-save"></i>&nbsp; Save & Continue</button>
                        </div> --}}
                    </section>
                </div>
            </div>
        ...
        <div class="card card-primary">
            <div class="card-header" id="accordion-header-member">
                <h4 class="card-title w-100">
                    <a class="d-block" data-toggle="collapse" href="#collapseMember" style="width: 100%;">MEMBER-IN-NEED INFORMATION</a>
                </h4>
            </div>
                    ...
                    <section>
                        <div class="col-12 form-row form-group">
                            <div class="col-md-6 float-left">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="member_fname" value="{{ $borDetails->first_name }}" required>
                                </div>
                            </div>
                            <div class="col-md-6 float-left">
                                <div class="form-group">
                                    <label>Members Last Name<span class="field-required">*</span></label>
                                    <input type="text" class="form-control" name="member_lname" value="{{ $borDetails->last_name }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 float-left">
                                ...
                                <div class="col-md-12 row" style="padding-left: 0;">
                                    <div class="form-check" style="margin-right: 20px;">
                                        <input class="form-check-input" type="radio" id="ReachableYes" name="member_reachable" value="1" {{ $grantDetails->member_reachable == 1 ? 'checked' : '' }} required onchange="ToggleAlternatePhone()">
                                        <label class="form-check-label" for="ReachableYes">Yes</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="ReachableNo" name="member_reachable" value="0" {{ $grantDetails->member_reachable == 0 ? 'checked' : '' }} onchange="ToggleAlternatePhone()">
                                        <label class="form-check-label" for="ReachableNo">No</label>
                                    </div>
                                </div>
                            </div>

                            <div class="col-md-6 float-left" id="divAlternatePhone" style="display: none;">
                                <div class="form-group">
                                    <label>Please provide an additional number<span class="field-required">*</span></label>
                                    <input type="tel" class="form-control" name="member_alt_phone">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 form-row form-group">
                            ...
                            <div class="col-md-12 mb-1">
                                <input type="text" class="form-control" name="member_street" id="member_street"placeholder="Address" required>
                            </div>
                            <div class="col-md-4 mb-1 float-left">
                                <input type="text" class="form-control" name="member_city" id="member_city" placeholder="City" required>
                            </div>
                            ...
                            <div class="col-md-2 mb-1 float-left">
                                <input type="text" class="form-control" name="member_zip" id="member_zip" placeholder="ZIP Code" required>
                            </div>
                        ...
                        <div class="col-12 form-row form-group">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="2" name="member_length" required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 form-row form-group">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="2" name="household_members" required></textarea>
                                </div>
                            </div>
                        </div>
        ...
        <div class="card card-primary">
            ...
            <div id="collapseSituation" class="collapse" data-parent="#accordion">
                <div class="card-body">
                    <section>
                        <div class="col-12 form-row form-group">
                            <p><strong>Please be as specific as possible.</strong> Did their house catch on fire? If so, how did the fire start and what was lost? If someone has a life-threatening illness, be specific.</p>
                        </div>
                        ...
                        <div class="col-12 form-row form-group">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" name="situation_summary" required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 form-row form-group">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="family_actions" required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 form-row form-group">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="financial_situation" required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 form-row form-group">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" name="pressing_needs" required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 form-row form-group">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="other_needs" required></textarea>
                                </div>
                            </div>
                        </div>
            ...
            <div id="collapseRequest" class="collapse" data-parent="#accordion">
                <div class="card-body">
                    <section>
                        <div class="col-12 form-row form-group">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="amount_requested" required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 form-row form-group">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="chapter_support" required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 form-row form-group">
                            <label>Upload photos of damage (if applicable)</label>
                            <div class="col-md-12">
                                <input type="file" class="form-control" name="damage_photos[]" multiple accept="image/*">
                                <small class="form-text text-muted">Max 5 files, jpg/gif/png only</small>
                            </div>
                        </div>
                    ...
                    <section>
                         <div class="col-12 form-row form-group">
                            ...
                            <div class="col-md-12 row">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="PreviousGrantNo" name="previous_grant" value="0" {{ $grantDetails->previous_grant == 0 ? 'checked' : '' }}>
                        ...
                        <div class="col-12 form-row form-group">
                            ...
                            <div class="col-md-12 row">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="BackingNo" name="chapter_backing" value="0" {{ $grantDetails->chapter_backing == 0 ? 'checked' : '' }}>
                        ...
                        <div class="col-12 form-row form-group">
                            ...
                            <div class="col-md-12 row">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="DonationNo" name="m2m_donation" value="0" {{ $grantDetails->m2m_donation == 0 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="affirmation" id="affirmation" class="mr-2"
                                    @checked(isset($grantDetails['affirmation']) && $grantDetails['affirmation'] == 1) required>
...
function ToggleAlternatePhone() {
    ...
    if (reachable && reachable.value === 'no') {
...
function EnsureConsent() {
    ...
    if (missingFields.length > 0) {
        ...
        var message = `<p>The following items in the BEFORE YOU BEGIN section must be acknowledged:</p>
...
function EnsureMemberInformation() {
    ...
    if (!document.querySelector('input[name="member_reachable"]:checked')) {
        ...
        // If "No" is selected, check for alternate phone
