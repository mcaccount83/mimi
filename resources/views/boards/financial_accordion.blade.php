    ...
    <div class="col-md-12 ">
        ...
        <div class="col-12 row mb-3">
            ...
            <div class="col-md-12 row">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="optNoFullDuesNo" name="optNoFullDues" value="0" {{ !is_null($chFinancialReport->not_all_full_dues) && $chFinancialReport->not_all_full_dues == 0 ? 'checked' : '' }} onchange="ChapterDuesQuestionsChange()">
...
<div id="collapseFourteen" class="collapse {{ $chFinancialReport->farthest_step_visited == '14' ? 'show' : '' }}" data-parent="#accordion">
    ...
    <section>
        ...
        <div class="card-body text-center mt-3">
            ...
            <button type="button" class="btn btn-success bg-gradient mb-2" id="final-submit" ><i class="bi bi-chevron-double-right me-2"></i>Submit Report</button>
        </div>
    </section>
</div><!-- end of accordion body -->
</div><!-- end of accordion item -->
