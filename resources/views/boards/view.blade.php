                    ...
                    <div class="documents-field">
                        ...
                        @if($chDetails->active_status == \App\Enums\ChapterStatusEnum::ACTIVE)
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-2">
                                    <button type="button" id="GoodStanding" class="btn btn-primary bg-gradient btn-sm keep-enabled" onclick="openPdfViewer('{{ route('pdf.chapteringoodstanding', ['id' => $chDetails->id]) }}')">Good Standing Chapter Letter</button><br>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="col-sm-8">
                                            @php
                                                ...
                                                if (isset($chFinancialReportQuestions['chapter_awards']) && !empty($chFinancialReportQuestions['chapter_awards'])) {
