...
@section('content')
    ...
    <div class="card-body text-center">
        ...
        <button id="Password" type="button" class="btn btn-primary" onclick="showChangePasswordAlert('{{ $PresDetails->user_id }}')"><i class="fas fa-lock" ></i>&nbsp; Change Password</button>
