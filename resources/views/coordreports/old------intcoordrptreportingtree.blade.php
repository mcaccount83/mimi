...
@section('breadcrumb', 'International Coordinator Reporting Tree')

@section('content')

@php
    $founderCondition = true;  // Force founder view for admin international tree
@endphp
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="dropdown">
                    <h3 class="card-title dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        International Coordinator Reporting Tree
                    </h3>
