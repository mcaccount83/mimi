...
A New Coordinator has been approved for Conference {{ $mailData['conference_id'] }}. Please create the following email address in Google GSuite.  If you choose to create an email address
