...
<p>This is to inform you that the MOMS Club of {{$mailData['chapterName']}}, {{$mailData['chapterState']}} has been placed on probation for not submitting the required End of Year reports. If you believe this information is incorrect, then please contact your Primary Coordinator immediately</p>
