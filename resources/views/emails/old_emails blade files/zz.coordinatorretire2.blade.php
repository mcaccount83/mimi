                                        ...
                                        <td class="w580" width="580">
                                            ...
                                            <div align="left" class="article-content">
                                                <div align="left" class="article-content">
                                                        ...
                                                        <!-- <p><b>{{$coordName}}</b>, has retired as a volunteer with Conference {{$confNumber}}.<br />
														Could you please remove their volunteer access to the PrezList and the VolList?</p><br /> -->	
                                                        <p>The following coordinator has retired: {{$coordName}}, {{$email}}, Conference {{ $confState}}.</p>
