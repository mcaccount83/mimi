...
@section('content')
 ...
 <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Boundary Issues&nbsp;<small>(Payment)</small></h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <input type="text" name="ch_territory" class="form-control" value="{{ $chapterList[0]->territory }}" maxlength="50" required onkeypress="return isAlphanumeric(event)" disabled >
			</div>
			</div>
			...
			<div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" name="ch_issue" class="form-control" value="{{ $chapterList[0]->boundary_issue_notes }}" maxlength="50" required onkeypress="return isAlphanumeric(event)" disabled >
			</div>
			</div>
            <div class="col-sm-12">
                <div class="custom-control custom-switch">
                    <input disabled type="checkbox" name="ch_resolved" id="ch_resolved" class="custom-control-input" {{$chapterList[0]->boundary_issue_resolved ? 'checked' : '' }} />
			...
			{{-- <div class="radio-chk">
              ...
              <button type="submit" class="btn bg-gradient-primary"><i class="fa fa-floppy-o fa-fw" aria-hidden="true" ></i>&nbsp; Save</button>
              <a href="{{ route('report.m2mdonation') }}" class="btn bg-gradient-primary"><i class="fa fa-reply fa-fw" aria-hidden="true" ></i>&nbsp; Back</a>
