		...
		<div class="col-md-12">
          <div class="box card">
            ...
            <div class="box-header with-border mrg-t-10">
              ...
              <div class="form-group">
                <label>Phone</label>
                <input type="text" name="ch_avp_phone" id="ch_avp_phone" class="form-control my-colorpicker1" value="{{ $chapterList[0]->phone }}" value="{{$AVPDetails[0]->avp_phone}}"disabled>
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-12 col-xs-12">
              ...
              <div class="form-group">
                ...
                <input type="text" name="ch_preknown" id="ch_preknown" class="form-control my-colorpicker1" value="{{ $chapterList[0]->former_name}}" maxlength="50" disabled>
              </div>
              </div>
              <!-- /.form group -->
              <div class="col-sm-6 col-xs-12">
              ...
              <div class="col-sm-6 col-xs-12">
				  <div class="form-group">
					...
					<label style="display: block;"><input disabled type="checkbox" name="" id="" class="ios-switch green bigswitch" {{$chapterList[0]->new_board_submitted != ''  ? 'checked' : ''}} /><div><div></div></div>
								</label>
				  </div>
              </div>
			  </div>
					...
					<div class="radio-chk">
						<div class="col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<label style="display: block;"><input disabled type="checkbox" name="" id="" class="ios-switch green bigswitch" {{$chapterList[0]->financial_report_received != ''  ? 'checked' : ''}} /><div><div></div></div>
								</label>
							</div>
						</div>
					</div>
			  ...
			  <div class="radio-chk">
				<div class="col-sm-6 col-xs-12">
				  <div class="form-group">
					...
					<label style="display: block;"><input disabled type="checkbox" name="" id="" class="ios-switch green bigswitch" {{$chapterList[0]->new_board_active != ''  ? 'checked' : ''}} /><div><div></div></div>
								</label>
				  </div>
				  </div>
              </div>
