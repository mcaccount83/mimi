...
@section('content')
    ...
    <div class="card-body">
                    ...
                    <!-- Filters -->
                    <form method="GET" action="{{ route('adminreports.intpaymentlist') }}" class="mb-6">
                    ...
                    <table id="chapterlist" class="table table-sm table-hover" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td  class="text-center align-middle"><a href="{{ route('adminreports.paymentdetails', $log->id) }}"><i class="fas fa-eye"></i></a></td>
                                <td>
                                    {{ $log->conf ?? 'N/A' }}
                                    {{-- @if ($log->customer_id)
