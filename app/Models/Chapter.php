...
class Chapter extends Model
{
    ...
    {
        return $this->hasOne(Documents::class, 'chapter_id', 'id'); // 'chapter_id' in financial_report references 'id' in chapters
    }
    ...
    {
        return $this->belongsTo(Country::class, 'country_short_name', 'short_name');
    }
    ...
    {
        return $this->belongsTo(Website::class, 'website_status', 'id');
    }
    ...
    {
        return $this->belongsTo(Coordinators::class, 'primary_coordinator_id');
    }
