...
class ReportController extends Controller
{
    ...
    public function showChapterStatus()
    {
        ...
        $data=array('chapterList' => $chapterList,'checkBoxStatus'=>$checkBoxStatus,'corId'=>$corId);
            ...
            public function showDownloads()
    {
        ...
        $data=array('chapterList' => $chapterList,'corId'=>$corId, 'positionId'=>$positionId, 'secPositionId'=> $secPositionId);
            ...
            public function showEINstatus()
    {
        ...
        $data=array('chapterList' => $chapterList,'corId'=>$corId);
    ...
    public function showChapterStatusView($id)
    {
        ...
        $data=array('chapterList' => $chapterList,'regionList'=>$regionList,'primaryCoordinatorList'=>$primaryCoordinatorList,'stateArr'=>$stateArr,'countryArr'=>$countryArr,'foundedMonth'=>$foundedMonth);
...
public function showBoardlist()
    {
        ...
        $data=array('countList'=>$countList,'activeChapterList' => $activeChapterList,'avpDeatils' => $avpDeatils,'mvpDeatils' => $mvpDeatils,'secDeatils' => $secDeatils,'trsDeatils' => $trsDeatils);
   ...
   /**
     ...
     */
        public function showEOYStatus()
        {
            ...
            $countList=count($chapterList);
            $data=array('countList' => $countList,'chapterList' => $chapterList,'checkBoxStatus'=>$checkBoxStatus);
     ...
     */
        ...
        if(isset($_GET['check2'])) {
            ...
            $data=array('chapterList' => $chapterList,'checkBoxStatus'=>$checkBoxStatus,'checkBox2Status'=>$checkBox2Status);
     ...
     */
        ...
        public function showReportToIssues()
        {
            ...
            $data=array('chapterList' => $chapterList,'checkBoxStatus'=>$checkBoxStatus);
               ...
               public function showChapterAwards()
        {
            ...
            $countList=count($chapterList);
            $data=array('corId'=>$corId,'countList'=>$countList,'chapter_array' => $chapterList,'checkBoxStatus'=>$checkBoxStatus);
    ...
    /** Board with No President List */
        ...
        $data=array('ChapterPres'=>$ChapterPres);
