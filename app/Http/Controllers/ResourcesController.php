...
class ResourcesController extends Controller implements HasMiddleware
{
    ...
    public function showToolkit(Request $request): View
    {
        ...
        $resources = Resources::with('toolkitCategory', 'updatedBy')->orderBy('name')->get();
    ...
    public function showAwards(Request $request): View
    {
        ...
        $data = [
            'reportYears' => $reportYears, 'eoyAwards' => $eoyAwards, 'canEditFiles' => $canEditFiles,
        ];
    ...
    public function showELearning(Request $request): View
    {
        ...
        return view('coordinators.resources.elearning')->with([
            'coordinatorCoursesByCategory' => $this->learndashService->getCoursesWithProgressByCategory('coordinator', $user),
