...
class ChapterController extends Controller implements HasMiddleware
{
    ...
    public function viewChapterDetails(Request $request, int $id): View
    {
        ...
        $data = ['id' => $id, 'chActiveId' => $chActiveId, 'positionId' => $positionId, 'coorId' => $coorId, 'reviewComplete' => $reviewComplete,
            ...
            'chIRSDocuments' => $chIRSDocuments, 'chReportDocuments' => $chReportDocuments, 'financialReportPdfs' => $financialReportPdfs, 'chFinancialReportQuestions' => $chFinancialReportQuestions
        ];
    ...
    public function updateChapterDisband(Request $request): JsonResponse
    {
        ...
        $endingBalanceLastYear = $documentsEOY->ending_balance_last_year ?? null;
    ...
    public function showChapterWebsite(Request $request): View
    {
        ...
        $data = ['websiteList' => $websiteList, 'checkBox1Status' => $checkBox1Status,
            'checkBox3Status' => $checkBox3Status,
