...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        if($user_type == 'coordinator'){
            ...
            else if($positionId <= 7 || $positionId == 25){
        ...
        if($user_type == 'board'){
            ...
            if($borPositionId == 1 && $isActive == 1){
                ...
                $data = array('chapterState'=>$chapterState,'currentMonth'=>$currentMonth,'foundedMonth'=>$foundedMonth,'stateArr'=>$stateArr,'SECDetails'=>$SECDetails,'TRSDetails'=>$TRSDetails,'MVPDetails'=>$MVPDetails,'AVPDetails'=>$AVPDetails,'chapterList' => $chapterList);
                return view('boards.president')->with($data);
            }elseif($borPositionId != 1 && $isActive == 1){
                $data = array('chapterState'=>$chapterState,'currentMonth'=>$currentMonth,'foundedMonth'=>$foundedMonth,'chapterDetails'=>$chapterDetails,'stateArr'=>$stateArr,'borPositionId' => $borPositionId,'borDetails' => $borDetails);
