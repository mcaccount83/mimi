...
class basePDFDataController extends Controller
{
    ...
    public function getFinancialReportCalculationsData(object $chFinancialReport)
    {
        return [
                ...
                'children_expenses_supplies' => $chFinancialReport->children_expenses_supplies,
                'children_expenses_other' => $chFinancialReport->children_expenses_other,
                ...
                'office_expenses_total' => $chFinancialReport->office_expenses_total,
