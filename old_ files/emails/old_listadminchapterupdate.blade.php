                                        ...
                                        <td class="w580" width="580">
                                            ...
                                            <div align="left" class="article-content">
                                                <div align="left" class="article-content">
                                                        ...
                                                        <p>The MOMS Club of {{$chapterNameUpd}}, {{$chapterStateUpd}} has been updated through the MOMS Information Management Interface.
                                                        </p>
                                                        ...
                                                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="1">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td></td>
                                                                    <td colspan="2" style="background-color: #D0D0D0;"><center><b>Chapter Email</b></center></td>
                                                                </tr>
                                                                ...
                                                                <tr class="{{$mvpemailPre != $mvpemailUpd ? 'highllgt' : ''}}">
                                                                    <td>E-mail</td>
                                                                    <td>{{$mvpemailPre}}</td>
                                                                    <td>{{$mvpemailUpd}}</td>
                                                                </tr>
